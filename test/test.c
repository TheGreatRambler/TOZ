...
int main() {
	...
	*(uint32_t*) init_config = 0;
	...
	config_hs.bmAttributes = USB_CONFIG_ATT_ONE | USB_CONFIG_ATT_SELFPOWER;//REAL ONE and WAKEUP;
	...
	config.bmAttributes = USB_CONFIG_ATT_ONE | USB_CONFIG_ATT_SELFPOWER;//REAL ONE and WAKEUP;
